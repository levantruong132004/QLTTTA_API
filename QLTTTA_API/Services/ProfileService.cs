...
namespace QLTTTA_API.Services
{
    ...
    public class ProfileService : BaseService, IProfileService
    {
        ...
        /// <summary>
        /// Truy vấn thông tin cá nhân của học viên đang đăng nhập. 
        /// Lấy ID từ session và query trực tiếp bảng HOC_VIEN (dùng kết nối Admin để đảm bảo quyền).
        /// </summary>
        ...
        /// <summary>
        /// Cập nhật thông tin cá nhân (Họ tên, Giới tính, Ngày sinh, SĐT, Địa chỉ) dựa vào ID học viên.
        /// </summary>
        public async Task<bool> UpdateMyProfileAsync(StudentProfileUpdateDto dto)
        {
            ...
            {
                _logger.LogError(ex, "UpdateMyProfileAsync: Lỗi cập nhật HOC_VIEN");
                return false;
            }
        }
