...
namespace QLTTTA_API.Services
{
    ...
    public class StaffService : BaseService, IStaffService
    {
        ...
        public async Task<List<StudentBrief>> SearchStudentsAsync(string? keyword)
        {
            ...
            // await TagClientAsync(conn, "staff"); // Admin connection doesn't need tagging for RLS if we bypass it, but good for audit. 
            // However, TagClientAsync uses USER which is QLTT_ADMIN. 
