                    ...
                    child: Column(
                      children: const [
                        Icon(Icons.person_add,
                            size: 48, color: RetroColors.vintageCream),
                        SizedBox(height: 8),
                        Text(
                          'TẠO TÀI KHOẢN MỚI',
                          style: TextStyle(
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            border: OutlineInputBorder(
              ...
              borderSide:
                  const BorderSide(color: RetroColors.vintageBrown, width: 2),
            ),
            enabledBorder: const OutlineInputBorder(
              borderRadius: BorderRadius.zero,
              borderSide: BorderSide(color: RetroColors.vintageBrown, width: 2),
            ),
