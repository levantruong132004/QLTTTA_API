              ...
              return Center(
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(color: RetroColors.vintageBurgundy, width: 3),
                  ),
                  child: Column(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      const Icon(Icons.error_outline, size: 48, color: RetroColors.vintageBurgundy),
              ...
              return Center(
                child: Container(
                  ...
                  child: const Column(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                    const Icon(Icons.search_off, size: 48, color: RetroColors.vintageGray),
                      SizedBox(height: 16),
                ...
                child: Column(
                  children: [
                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(color: RetroColors.vintageGold, width: 3),
                            ),
                            child: Center(
                              child: Text(
                                student.hoTen.isNotEmpty ? student.hoTen[0].toUpperCase() : '?',
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: RetroColors.vintageBrown,
                              border: Border.all(color: RetroColors.vintageGold, width: 2),
                            ),
                            child: Text(
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          _buildProfileItem(Icons.person, 'MÃ HỌC VIÊN', student.maHocVien),
                          _buildProfileItem(Icons.badge, 'HỌ TÊN', student.hoTen),
                          _buildProfileItem(Icons.phone, 'SỐ ĐIỆN THOẠI', student.soDienThoai ?? 'Không có'),
                          _buildProfileItem(Icons.cake, 'NGÀY SINH', DateFormat('dd/MM/yyyy').format(student.ngaySinh)),
                          _buildProfileItem(Icons.home, 'ĐỊA CHỈ', student.diaChi ?? 'Không có'),
                        ],
                      ),
                    ),
                  ],
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              color: RetroColors.vintageBrown,
              border: Border(
                right: BorderSide(color: RetroColors.vintageDarkBrown, width: 2),
              ),
            ),
            child: Icon(
              icon,
