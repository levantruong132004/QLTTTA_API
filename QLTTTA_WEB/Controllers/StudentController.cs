            ...
            try
            {
                ...
                if (invByReg.IsSuccessStatusCode)
                {
                    try
                    {
                        ...
                        {
                            // Fix: Check if data contains "invoice" property (new API structure)
                            if (TryGetPropertyCI(tmpData, "invoice", out var innerInvoice))
                            {
                                invData = innerInvoice;
                            }
                            else
                            {
                                invData = tmpData;
